CREATE DATABASE  IF NOT EXISTS `nextstop` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `nextstop`;
...
INSERT INTO `usuarios_usuario` VALUES (67,'Brian Mauss','maussbrian06@gmail.com','pbkdf2_sha256$1000000$SNtooyuJUzE9Lf0lSeL7KT$BLH/zGNdmPmj5BG8wceMmpH9AC6hDW7S4njAuRiqItw=','2294163258','es','MXN',1,'2025-11-05 03:44:03.314586',1),(68,'Ines  Francisco','alondrmtz38@gmail.com','pbkdf2_sha256$1000000$m9BJQ8jPiH9mRLEnH6dvWI$dThIvWxDEpgoAkDr06JFQV7FlcSXwCsZBqMhK3b+uFg=','2294163258','es','MXN',1,'2025-11-05 14:06:15.764594',1);
...
CREATE TABLE `usuarios_verificacion` (
  ...
  KEY `usuarios_verificacion_usuario_id_dc891766_fk_usuarios_usuario_id` (`usuario_id`),
  CONSTRAINT `usuarios_verificacion_usuario_id_dc891766_fk_usuarios_usuario_id` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios_usuario` (`id`)
...
INSERT INTO `usuarios_verificacion` VALUES (1,'6394','5a906449-e7ae-4b78-baa5-1e9b488c3a8a','2025-11-05 03:45:03.319558',1,67),(2,'5453','92d255fc-8cba-495a-bad4-1d0a24e5ecb1','2025-11-05 14:07:15.778362',1,68);
/*!40000 ALTER TABLE `usuarios_verificacion` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping routines for database 'nextstop'
--
...
-- Dump completed on 2025-11-11 18:05:14
